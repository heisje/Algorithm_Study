...
def how_many_times(target_ch, out_num, broken):
    ...
    return min((up_num - int(target_ch) + len(target_ch)), (int(target_ch) - down_num + len(target_ch)),
               abs(int(target_ch) - 100))
